...
3. Каждый образ из 2-4 вещей, которые хорошо сочетаются
4. МИКСУЙ вещи пользователя [USER] и партнёрские [PARTNER] в одном образе
5. Учитывай погоду ({temp}°C) при выборе вещей
6. Придумай стильное короткое название для каждого образа (3-5 слов)
7. Учитывай пол ({gender or 'не указан'})
